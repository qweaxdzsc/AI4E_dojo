...
from variants import consume_error
...
def analyze_sample(reference, *, cfg, output):
    ...
    statistics["absolute_error"] = consume_error(fields)
    ...
    if "surface" in figures:
        ...
        images["absolute_error"] = post_ops.render_field(
            surface, field="surface.absolute_error", **view
        )
