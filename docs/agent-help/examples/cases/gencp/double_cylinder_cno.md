<!-- dojo-help: {"case_ids": ["gencp.double_cylinder_cno"], "domain": "gencp", "kind": "case", "layer": "example", "summary": "耦合物理场生成研究", "title": "gencp.double_cylinder_cno", "topic_id": "case:gencp.double_cylinder_cno"} -->
