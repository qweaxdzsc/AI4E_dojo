<!-- dojo-help: {"case_ids": ["gencp.turek_hron_sit_fno"], "domain": "gencp", "kind": "case", "layer": "example", "summary": "耦合物理场生成研究", "title": "gencp.turek_hron_sit_fno", "topic_id": "case:gencp.turek_hron_sit_fno"} -->
