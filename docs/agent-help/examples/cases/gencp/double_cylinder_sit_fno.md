<!-- dojo-help: {"case_ids": ["gencp.double_cylinder_sit_fno"], "domain": "gencp", "kind": "case", "layer": "example", "summary": "耦合物理场；独立场训练后以明确顺序组合生成。", "tasks": ["field_sequence", "coupled_fields", "model", "objective", "neutron_condition", "solid_condition", "fluid_condition"], "title": "gencp.double_cylinder_sit_fno", "topic_id": "case:gencp.double_cylinder_sit_fno"} -->
# `gencp.double_cylinder_sit_fno`

- 类型：`standalone`
- 用途：耦合物理场生成研究
- 资源路径：`examples/gencp/double_cylinder_sit_fno`
...
来源：案例 README；SHA256 `99df6d94ba3c3c400df885ca38d1476aa463e8e9c76e59009b399bbc8818cfd4`。
