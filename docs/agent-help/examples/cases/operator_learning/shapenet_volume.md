<!-- dojo-help: {"case_ids": ["operator_learning.shapenet_volume"], "domain": "operator_learning", "kind": "case", "layer": "example", "summary": "shapenet_volume的算子学习研究", "tasks": ["regular_grid", "scalar_field", "model", "derived", "consume"], "title": "operator_learning.shapenet_volume", "topic_id": "case:operator_learning.shapenet_volume"} -->
# `operator_learning.shapenet_volume`

- 类型：`standalone`
- 用途：shapenet_volume的算子学习研究
- 资源路径：`examples/operator_learning/shapenet_volume`

shapenet_volume的算子学习研究
...
- 数据集：`shapenet_volume`
- 入口：`pipeline.py`
- Recipe 来源：`operator_learning/shapenet_volume`
...
来源：案例 README；SHA256 `7889a8171838a5603a7749e27795fc9156384d58f60d8144f3b60da93fd9525b`。
...
复制后可改写分支/主干 binding、网络构造器或阶段正文，但须保留逐车物理坐标与实体身份交接。
