<!-- dojo-help: {"case_ids": ["safediffcon.tokamak"], "domain": "safediffcon", "kind": "case", "layer": "example", "summary": "控制扩散研究", "title": "safediffcon.tokamak", "topic_id": "case:safediffcon.tokamak"} -->
# `safediffcon.tokamak`
