<!-- dojo-help: {"case_ids": ["recipe_extensions.network_composition.unet_transformer"], "domain": "recipe_extensions", "kind": "case", "layer": "example", "summary": "标准注意力阶段替换U-Net瓶颈；先物化完整基案例，再用公开计算阶段改写网络。", "tasks": ["regular_grid", "scalar_field", "model", "derived", "consume"], "title": "recipe_extensions.network_composition.unet_transformer", "topic_id": "case:recipe_extensions.network_composition.unet_transformer"} -->
# `recipe_extensions.network_composition.unet_transformer`

- 类型：`extension`
- 用途：标准注意力阶段替换U-Net瓶颈
- 资源路径：`examples/recipe_extensions/network_composition/unet_transformer`

标准注意力阶段替换U-Net瓶颈；先物化完整基案例，再用公开计算阶段改写网络。
...
来源：案例 README；SHA256 `a302deb563f9294e3febbaa442493ae9a9e1f8547674dc169518d4ae0a32f36c`。
