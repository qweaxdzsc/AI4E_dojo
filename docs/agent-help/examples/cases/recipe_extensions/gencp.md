<!-- dojo-help: {"case_ids": ["recipe_extensions.gencp"], "domain": "recipe_extensions", "kind": "case", "layer": "example", "summary": "耦合条件替换、派生输出和单场重训；先物化完整基案例，再按扩展说明修改。", "tasks": ["field_sequence", "coupled_fields", "condition", "post", "field_retraining"], "title": "recipe_extensions.gencp", "topic_id": "case:recipe_extensions.gencp"} -->
...
- 替换入口：condition, post, field_retraining
...
来源：案例 README；SHA256 `c4e1c6f4ada2503ac0697bc9f9be7efc814ed16ad715acedcd342ad0b969cce7`。
...
基案例完整说明：[本地正文](../gencp/double_cylinder_cno.md)。
