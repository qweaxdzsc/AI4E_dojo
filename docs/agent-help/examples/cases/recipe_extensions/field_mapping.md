<!-- dojo-help: {"case_ids": ["recipe_extensions.field_mapping"], "domain": "recipe_extensions", "kind": "case", "layer": "example", "summary": "物理字段派生与保存、统计和归一化交接；先物化完整基案例，再按扩展说明修改。", "tasks": ["mesh", "point_fields", "field_transform"], "title": "recipe_extensions.field_mapping", "topic_id": "case:recipe_extensions.field_mapping"} -->
...
来源：案例 README；SHA256 `abb1f7a3a89f9ca6925c9bf75ce4de9789d3fcb69a246413f974cd5dacfab072`。
