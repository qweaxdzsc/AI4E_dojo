<!-- dojo-help: {"case_ids": ["recipe_extensions.safediffcon"], "domain": "recipe_extensions", "kind": "case", "layer": "example", "summary": "控制网络、安全目标和安全裕量计算替换；先物化完整基案例，再按扩展说明修改。", "tasks": ["field_sequence", "control_trajectory", "network", "objective", "diagnostics"], "title": "recipe_extensions.safediffcon", "topic_id": "case:recipe_extensions.safediffcon"} -->
...
- 替换入口：network, objective, diagnostics
...
来源：案例 README；SHA256 `67b34490e2f1bc03e8e4631f13eedf8ac142d75b855f41695576070b0a92db03`。
