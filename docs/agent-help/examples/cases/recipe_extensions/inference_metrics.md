<!-- dojo-help: {"case_ids": ["recipe_extensions.inference_metrics"], "domain": "recipe_extensions", "kind": "case", "layer": "example", "summary": "物理字段评价函数的局部替换；先物化完整基案例，再按扩展说明修改。", "tasks": ["mesh", "point_fields", "metrics"], "title": "recipe_extensions.inference_metrics", "topic_id": "case:recipe_extensions.inference_metrics"} -->
# `recipe_extensions.inference_metrics`

- 类型：`extension`
- 用途：参考变体与 Agent 组件组装示例
- 资源路径：`examples/recipe_extensions/inference_metrics`
...
来源：案例 README；SHA256 `ceeed7da59697542271cc1b49e14c3ec2cadda6ac7b4d6e4e43216d2f917d74c`。
