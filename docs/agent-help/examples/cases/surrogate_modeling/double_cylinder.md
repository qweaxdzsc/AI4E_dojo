<!-- dojo-help: {"case_ids": ["surrogate_modeling.double_cylinder"], "domain": "surrogate_modeling", "kind": "case", "layer": "example", "summary": "double_cylinder的传统代理与降阶研究", "tasks": ["regular_grid", "scalar_field", "fit", "rebuild"], "title": "surrogate_modeling.double_cylinder", "topic_id": "case:surrogate_modeling.double_cylinder"} -->
# `surrogate_modeling.double_cylinder`

- 类型：`standalone`
- 用途：double_cylinder的传统代理与降阶研究
- 资源路径：`examples/surrogate_modeling/double_cylinder`

double_cylinder的传统代理与降阶研究
...
- 数据集：`double_cylinder`
- 入口：`pipeline.py`
- Recipe 来源：`surrogate_modeling/double_cylinder`
...
来源：案例 README；SHA256 `9644807fcb26c59268441a31a212944b0bd1965c3477e1f0e18865248e56ed58`。
...
复制后可改写系数代理的 fit/rebuild 组件或 POD 秩，但准备身份、标准化和时间窗口变化必须触发兼容性检查。
