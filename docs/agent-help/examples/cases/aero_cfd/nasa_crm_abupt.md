<!-- dojo-help: {"case_ids": ["aero_cfd.nasa_crm_abupt"], "domain": "aero_cfd", "kind": "case", "layer": "example", "summary": "外流 CFD 联合域预测", "title": "aero_cfd.nasa_crm_abupt", "topic_id": "case:aero_cfd.nasa_crm_abupt"} -->
