<!-- dojo-help: {"case_ids": ["aero_cfd.nasa_crm_meshgraphnet"], "domain": "aero_cfd", "kind": "case", "layer": "example", "summary": "NASA CRM 表面 Cp 与 Cf 分区图预测", "title": "aero_cfd.nasa_crm_meshgraphnet", "topic_id": "case:aero_cfd.nasa_crm_meshgraphnet"} -->
