<!-- dojo-help: {"case_ids": ["aero_cfd.nasa_crm_transolver3"], "domain": "aero_cfd", "kind": "case", "layer": "example", "summary": "外流 CFD 表面预测", "title": "aero_cfd.nasa_crm_transolver3", "topic_id": "case:aero_cfd.nasa_crm_transolver3"} -->
