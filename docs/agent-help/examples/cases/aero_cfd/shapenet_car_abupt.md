<!-- dojo-help: {"case_ids": ["aero_cfd.shapenet_car_abupt"], "domain": "aero_cfd", "kind": "case", "layer": "example", "summary": "汽车表面与体积预测", "title": "aero_cfd.shapenet_car_abupt", "topic_id": "case:aero_cfd.shapenet_car_abupt"} -->
