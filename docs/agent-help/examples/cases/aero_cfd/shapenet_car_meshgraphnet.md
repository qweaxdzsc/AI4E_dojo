<!-- dojo-help: {"case_ids": ["aero_cfd.shapenet_car_meshgraphnet"], "domain": "aero_cfd", "kind": "case", "layer": "example", "summary": "汽车表面压力与体积速度图预测", "title": "aero_cfd.shapenet_car_meshgraphnet", "topic_id": "case:aero_cfd.shapenet_car_meshgraphnet"} -->
