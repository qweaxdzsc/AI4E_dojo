<!-- dojo-help: {"case_ids": ["aero_cfd.nasa_crm_geotransolver"], "domain": "aero_cfd", "kind": "case", "layer": "example", "summary": "NASA CRM 表面 Cp 与 Cf 条件点场预测", "title": "aero_cfd.nasa_crm_geotransolver", "topic_id": "case:aero_cfd.nasa_crm_geotransolver"} -->
