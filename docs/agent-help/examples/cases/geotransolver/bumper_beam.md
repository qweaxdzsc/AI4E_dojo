<!-- dojo-help: {"case_ids": ["geotransolver.bumper_beam"], "domain": "geotransolver", "kind": "case", "layer": "example", "summary": "具名网格场/轨迹预测工程对照", "title": "geotransolver.bumper_beam", "topic_id": "case:geotransolver.bumper_beam"} -->
