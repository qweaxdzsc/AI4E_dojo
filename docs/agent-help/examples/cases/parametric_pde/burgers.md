<!-- dojo-help: {"case_ids": ["parametric_pde.burgers"], "domain": "parametric_pde", "kind": "case", "layer": "example", "summary": "参数化 PDE 研究", "title": "parametric_pde.burgers", "topic_id": "case:parametric_pde.burgers"} -->
