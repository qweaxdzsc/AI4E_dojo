<!-- dojo-help: {"case_ids": ["parametric_pde.neumann_diffusion"], "domain": "parametric_pde", "kind": "case", "layer": "example", "summary": "参数化 PDE 研究", "title": "parametric_pde.neumann_diffusion", "topic_id": "case:parametric_pde.neumann_diffusion"} -->
