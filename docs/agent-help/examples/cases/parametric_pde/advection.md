<!-- dojo-help: {"case_ids": ["parametric_pde.advection"], "domain": "parametric_pde", "kind": "case", "layer": "example", "summary": "参数化 PDE 研究", "title": "parametric_pde.advection", "topic_id": "case:parametric_pde.advection"} -->
