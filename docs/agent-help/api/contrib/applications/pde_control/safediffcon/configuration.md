...
- 模块：`ai4e_contrib.application.pde_control.safediffcon.configuration`
- 仓库相对路径：`packages/ai4e-contrib/application/pde_control/safediffcon/configuration.py:163`
- 安装源码：先调用 `ai4e_task.source_location('ai4e_contrib')`，再按模块相对路径定位。
...
- 模块：`ai4e_contrib.application.pde_control.safediffcon.configuration`
- 仓库相对路径：`packages/ai4e-contrib/application/pde_control/safediffcon/configuration.py:149`
- 安装源码：先调用 `ai4e_task.source_location('ai4e_contrib')`，再按模块相对路径定位。
...
- 模块：`ai4e_contrib.application.pde_control.safediffcon.configuration`
- 仓库相对路径：`packages/ai4e-contrib/application/pde_control/safediffcon/configuration.py:143`
- 安装源码：先调用 `ai4e_task.source_location('ai4e_contrib')`，再按模块相对路径定位。
