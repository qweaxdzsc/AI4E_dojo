"""SafeDiffCon 上游数值实现；仅调整包内导入，来源见模型目录 source.json。"""
import torch
...
from ai4e_contrib.ability.model.safediffcon.burgers_model_utils import linear_beta_schedule, cosine_beta_schedule,\
